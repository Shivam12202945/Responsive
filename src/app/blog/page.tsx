  ...
  return (
    <>
      ...
      <div className="bg-black">
        <div className="container pt-32 md:pt-20 mx-auto px-4">
          <section>
            {/* <Chatbot/> */}
            <motion.div
            ...
            >
              <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 className="mb-4 text-2xl sm:text-3xl lg:text-4xl tracking-tight font-extrabold text-white">
                  Our Blog
                </h2>
                <p className="font-light text-gray-200 sm:text-lg md:text-xl">
                ...
                {Data.map((blog, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      >
                        {expandedBlogs.includes(index) ? "Show less" : "Read more"}
                        <svg
